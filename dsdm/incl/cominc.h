...
C     PARAMETER (LM=600000,LDM=80000000,NBTTM=2000,NBTTDM=4000)
      PARAMETER (LM=3000000,LDM=260000000,NBTTM=4000,NBTTDM=6000)
...
CC*   NBCOL est le nombre de colonnes
      INTEGER   NBCOL
C
CC*   NBIMP est le nombre de bords à déplacements imposés
      INTEGER   NBIMP
C   
C *
...
C -    TRACT=.TRUE. ==> type flexion
C -    VOLUM=.TRUE. ==> type volumique
...
C -
      ...
      LOGICAL     DONVOL
      LOGICAL     POLAR   
C     DONHER  : Logique indiquant si il y a des donnees de type pression de hertz
C     par fichier
C     NBELZC : nombre d'EF de la zone de contact si DONHER
      LOGICAL DONHER
      INTEGER NBELZC      
C -
...
C -
     ...
     &               , NBTADM , NBTAM , VERAM(NBTTM) , VERADM( NBTTDM)
      COMMON / GEOMEN /  NBCOU , NBCOL , NBIMP, NNOEUD
     &               , NDDL , NEL1 , NEL2 , NUM ,
...
C *                                   
     ...
     &                 TRACT   , VOLUM, POLAR , DONHER , NBELZC
